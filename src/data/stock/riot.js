...
const data = [ {
  ...
  month: '202502',
  trans: [
    { day: 21, price: 10.58, number: 100, direction: BUY, fee: 1.30, t: '14 收益 92' },
  ]
}, {
  month: '202503',
  trans: [
  ...
  trans: [
    ...
    { day: 7, price: 12.1, number: 50, direction: SELL, fee: 1.17, t: '15 收益 55' },
    { day: 8, price: 11, number: 50, direction: BUY, fee: 1.16, t: '16' },
    { day: 14, price: 12, number: 50, direction: SELL, fee: 1.17, t: '16 收益 50' },
  ...
  month: '202509',
  trans: [
    { day: 4, price: 13, number: 50, direction: BUY, fee: 0.52, t: '17 收益 50' },
