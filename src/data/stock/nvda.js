...
const data = [ {
  ...
  month: '202607',
  trans: [
    { day: 27, price: 199.9, number: 5, direction: BUY, fee: 1.03, t: 2 },
    { day: 27, price: 196, number: 8, direction: BUY, fee: 1.03 },
  ]
}, {
  month: '202608',
  trans: [
    { day: 4, price: 211, number: 5, direction: SELL, fee: 1.06, t: 2 },
    { day: 5, price: 222, number: 5, direction: SELL, fee: 1.06, t: 5 },
    { day: 24, price: 210, number: 5, direction: BUY, fee: 1.03, t: 3 },
    { day: 25, price: 213.5, number: 5, direction: SELL, fee: 1.06, t: 3 },
    { day: 26, price: 210, number: 5, direction: BUY, fee: 1.03, t: 4 },
    { day: 26, price: 220, number: 5, direction: SELL, fee: 1.06, t: 4 },
  ]
}, {
  month: '202609',
  trans: [
    ...
    { day: 14, price: 210, number: 5, direction: BUY, fee: 1.03, t: 6 },
    { day: 17, price: 220.52, number: 5, direction: SELL, fee: 0 }, // fee todo
  ]
} ];
