...
const data = [
  ...
  },
  {
    ...
    trans: [
      ...
      { day: 21, price: 19, number: 50, direction: BUY, fee: 1.15, t: 'grid 53' },
      { day: 23, price: 17.485, number: 50, direction: BUY, fee: 1.15, t: 'grid 50' },
      { day: 23, price: 17, number: 50, direction: BUY, fee: 1.15, t: 'grid 49' },
    ]
  }, {
    month: '202508',
    monthlyProfit: 101.5,
    trans: [
      { day: 1, price: 15.5, number: 50, direction: BUY, fee: 0.52, t: 'grid 48' },
      { day: 14, price: 15, number: 50, direction: BUY, fee: 1.16, t: 'grid 45' },
      { day: 18, price: 16, number: 50, direction: SELL, fee: 1.17, t: 'grid 45 收益 50' },
      { day: 20, price: 15, number: 50, direction: BUY, fee: 1.16, t: 'grid 46' },
      { day: 22, price: 16.03, number: 50, direction: SELL, fee: 1.17, t: 'grid 46 收益 51.5' },
    ]
  }, {
    month: '202509',
    monthlyProfit: 0,
    trans: [
      { day: 5, price: 14.8, number: 50, direction: BUY, fee: 1.16, t: 'grid 47' },
      { day: 9, price: 16, number: 50, direction: SELL, fee: 1.17, t: 'grid 47 收益 60' },
      { day: 16, price: 17, number: 50, direction: SELL, fee: 1.17, t: 'grid 48 收益 75' },
      { day: 18, price: 18, number: 50, direction: SELL, fee: 1.17, t: 'grid 49 收益 50' },
      { day: 18, price: 19, number: 50, direction: SELL, fee: 1.17, t: 'grid 50 收益 75.75' },
      { day: 25, price: 16.8, number: 100, direction: BUY, fee: 1.31, t: 'grid52' },
      { day: 25, price: 15.9, number: 50, direction: BUY, fee: 1.16, t: 'grid51' },
      { day: 29, price: 17, number: 50, direction: SELL, fee: 1.17, t: 'grid51 收益 55' },
      { day: 29, price: 18, number: 50, direction: SELL, fee: 1.17, t: 'grid52' },
    ]
  }, {
    month: '202510',
    monthlyProfit: 0,
    trans: [
      { day: 1, price: 19.1, number: 50, direction: SELL, fee: 0.53, t: 'grid52 收益 175' },
      { day: 6, price: 20, number: 50, direction: SELL, fee: 0, t: 'grid 53 收益 50' },
    ]
  }
];
