...
const data = [ {
  ...
  trans: [
    ...
    { day: 18, price: 12.1, number: 100, direction: BUY, fee: 1.30, t: 't15' },
    { day: 18, price: 12, number: 100, direction: BUY, fee: 1.30, t: 't14' },
  ...
  month: '202508',
  trans: [
    { day: 8, price: 10, number: 100, direction: BUY, fee: 1.31, t: '13' },
  ...
  trans: [
    ...
    { day: 25, price: 13.5, number: 100, direction: BUY, fee: 1.31, t: 't17' },
    { day: 26, price: 12.5, number: 100, direction: BUY, fee: 1.31, t: 't16' },
    { day: 26, price: 13.5, number: 100, direction: SELL, fee: 1.33, t: 't16 | 收益 100' },
    { day: 29, price: 14.5, number: 100, direction: SELL, fee: 1.33, t: 't17 | 收益 100' },
  ]
}, {
  month: '202510',
  trans: [
    { day: 3, price: 16, number: 100, direction: SELL, fee: 0 },
  ]
} ];
export {
  currentPrice,
