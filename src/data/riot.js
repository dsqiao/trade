...
const data = [{
  ...
  trans: [
    ...
    { day: 12, price: 13.05, number: 100, direction: SELL, fee: 0, t: '3 收益 115' },
    { day: 12, price: 12, number: 100, direction: BUY, fee: 0, t: '5' },
    { day: 12, price: 13, number: 100, direction: SELL, fee: 0, t: '5 收益 100' },
  ]
}]
export {
  currentPrice,
