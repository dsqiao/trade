...
const cashflow = [ {
  ...
  month: '202512',
  record: [
    { day: 5, num: 1400, cny: 9730, platform: PLATFORM.OKX, direction: BUY, desc: '' },
    { day: 5, num: 1000, cny: 6950, platform: PLATFORM.OKX, direction: BUY, desc: '' },
    { day: 22, num: 900, cny: 6246, platform: PLATFORM.AC, direction: BUY, desc: '' },
  ]
}, {
  month: '202601',
  record: [
    { day: 5, num: 2000, cny: 13800, platform: PLATFORM.AC, direction: BUY, desc: 'jyh/bn' },
  ...
  record: [
    ...
    { day: 5, num: 1400, cny: 9786, platform: PLATFORM.OKX, direction: BUY, desc: '' },
    { day: 6, num: 1000, cny: 7000, platform: PLATFORM.OKX, direction: BUY, desc: '' },
    { day: 12, num: 1400, cny: 9646, platform: PLATFORM.OKX, direction: BUY, desc: '' },
    { day: 12, num: 1400, cny: 9646, platform: PLATFORM.OKX, direction: BUY, desc: '' },
    { day: 12, num: 1400, cny: 9646, platform: PLATFORM.OKX, direction: BUY, desc: '' },
    { day: 12, num: 1400, cny: 9660, platform: PLATFORM.OKX, direction: BUY, desc: '' },
    { day: 13, num: 1400, cny: 9716, platform: PLATFORM.OKX, direction: BUY, desc: '' },
    { day: 13, num: 1400, cny: 9632, platform: PLATFORM.OKX, direction: BUY, desc: '' },
    { day: 15, num: 1400, cny: 9604, platform: PLATFORM.OKX, direction: BUY, desc: '' },
  ]
}, {
  month: '202603',
  record: [
    { day: 7, num: 1000, cny: 6940, platform: PLATFORM.OKX, direction: BUY, desc: '' },
  ]
}, {
  month: '202604',
  record: [
    ...
    { day: 30, num: 2400, cny: 16368, platform: PLATFORM.AC, direction: BUY, desc: 'jyh/bn & wx' },
  ]
}, {
  month: '202605',
  record: [
    { day: 19, num: 900, cny: 6075, platform: PLATFORM.AC, direction: BUY, desc: 'jyh/bn' },
  ]
}, {
  month: '202606',
  record: [
    { day: 5, num: 2000, cny: 13600, platform: PLATFORM.AC, direction: BUY, desc: 'jyh/bn' },
  ]
}, {
  month: '202607',
  record: [
    { day: 5, num: 1200, cny: 8100, platform: PLATFORM.OKX, direction: BUY, desc: '' },
  ]
}, {
  month: '202608',
  record: [
    { day: 5, num: 1000, cny: 6700, platform: PLATFORM.AC, direction: BUY, desc: 'jyh/bn' },
  ]
} ];
